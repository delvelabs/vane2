...
class TestOutputManager(TestCase):
    ...
    def test_to_pretty_output_format_output_with_defined_order(self):
        with patch("vane.outputmanager.termcolor.colored", fake_colored):
            ...
            self.output_manager.add_plugin("plugins/plugin", "1.2.3", Meta(key="plugins/plugin", name="Plugin",
                                                                           url="url"))
            ...
            expected_output = "{0}Plugins:\n{1}Themes:\n{2}General Log:\nmessage...\n"\
                .format(self.output_manager._format_component(self.output_manager.data["wordpress"]),
                        self.output_manager._format_component(self.output_manager.data["plugins"][0]),
                        self.output_manager._format_component(self.output_manager.data["themes"][0]))
    ...
    def test_format_vulnerability_reference_indent_references(self):
        ...
        pretty_ref = self.output_manager._format_vulnerability_reference(ref, indent_level=1)
    ...
    def test_format_component_add_emptyline_at_end(self):
        ...
        output = self.output_manager._format_component(component)
    ...
    def test_format_component_set_vulnerabilities_first_line_in_bold_red(self):
        ...
        output = self.output_manager._format_component(self.output_manager.data["plugins"][0])
    ...
    def test_format_component_add_message_if_no_vulnerabilities_for_component(self):
        ...
        output = self.output_manager._format_components(self.output_manager.data["plugins"], "Plugins")
